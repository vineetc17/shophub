...
public class UserDAOImpl implements UserDAO {
    ...
    public List<UserDto> getAll() {
        String sql_customers = "select u.id, u.username, u.role,u.date_joined, c.first_name, c.last_name from user u, customer c where u.id = c.user_id";
        String sql_shopkeepers = "select u.id, u.username, u.role, u.date_joined, s.first_name, s.last_name from user u, shopkeeper s where u.id = s.user_id";
