...
const Dashboard = () => {
  ...
  const ShowChoiceItem = () => {
    ...
    else if (press === 3) return <Reviews />;
        ...
        <Grid item xs={3}>
          ...
          <Item>
            ...
            >
              ...
              <Button onClick={() => { setPress(4) }} fullWidth variant={press === 4 ? "contained" : "text"}><DeleteIcon /><Typography sx={{ ml: 'auto' }}>delete account</Typography></Button>
            </Stack>
          </Item>
        </Grid>
        <Grid item xs={9}>
